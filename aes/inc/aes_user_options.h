...
/////////////////////////////////////////////////////////////
#define AES_FORCE_TABLES_INTO_CODE_MEMORY_WITH_SDCC		0	//Force the sbox, sbox_inv, and rcon tables into code memory using the __code keyword (only for SDCC)
...
#define AES_USE_USER_DEFINED_GALOIS_MULTIPLY_FUNCTION	0	//Use section below to define an alternate Galois multiplier function than the one used in the library
